...
public class Jeu
{
    ...
    private void InitQuestions()
    {
        questions = new List<Question>
        {
            ...
            new Question(Attribut.CheveuxTypeFrises, "A-t-il les cheveux frisés ?", "Oui, Il a les cheveux frisés", "Non, Il n'a pas les cheveux frisés"),
            new Question(Attribut.CheveuxTypeRaides, "A-t-il les cheveux raides ?", "Oui, Il a les cheveux raides", "Non, Il n'a pas les cheveux raides"),
            new Question(Attribut.CheveuxTypeOndules, "A-t-il les cheveux ondulés ?", "Oui, Il a les cheveux ondulés", "Non, Il n'a pas les cheveux ondulés"),
